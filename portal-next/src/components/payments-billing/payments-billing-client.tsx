        ...
        onSuccess: async (transaction) => {
          ...
          try {
            ...
            if (verifyRes.ok && verifyJson.status === 'success') {
              ...
              setError(
                method === 'transfer'
                  ? 'We could not confirm your transfer yet. If you already sent the money, this can take a few minutes — refresh this page shortly.'
            ...
            <>
              ...
              <div className="mt-1 flex items-center justify-between gap-3">
                ...
                >
                  ...
                  {status === 'done' && (method === 'card' ? '✓ Trial Started' : '✓ Payment Received')}
                </button>
              </div>
